...
SRC_$(d)				:= $(wildcard $(d)/rtl/d8_*.v)

# Isim simulations

# SIM 			      := $(call SRC_2_BIN, $(d)/sim_d8_top)
# SRC_SIM_$(d)		:= $(SRC_$(d)) $(d)/rtl/sim_d8_top.vhd
# $(SIM).prj			: $(SRC_SIM_$(d))
...
SIM 			      := $(call SRC_2_BIN, $(d)/d8_top.sim)
SRC_SIM_$(d)		:= $(SRC_$(d)) $(d)/rtl/sim_d8_top.v $(XILINX_SRC_$(d))
$(SIM)					: $(SRC_SIM_$(d))
